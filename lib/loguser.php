...
{
	$loguser = array("name"=>"", "powerlevel"=>0, "threadsperpage"=>30, "postsperpage"=>10, "theme"=>Settings::get("defaultTheme"),
		"dateformat"=>"d.m.y", "timeformat"=>"h:i A", "fontsize"=>80, "timezone"=>0, "blocklayouts"=>!Settings::get("guestLayouts"),
